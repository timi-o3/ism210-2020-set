...
const Component9: React.FC = () => {
  ...
  const setDateCommissioned = (_event: any, date: Date | undefined) => {
    const dateCommissioned = date || state.museumItem.dateCommissioned; //if no date is passed with call, usethe existing dateCommissioned
    setState({
      ...state,
      museumItem: { ...state.museumItem, dateCommissioned: dateCommissioned },
  ...
  const handleCreateItem = async (itemToCreate: MuseumItemType) => {
    ...
    try {
      const response = await fetch(
        "http://{server-address}:1337/museum-items",
        {
          method: "POST",
          headers: {
  ...
  return (
    <View>
      ...
      <View>
        ...
        <TextInput
          placeholder="Enter name of artwork here"
          onChangeText={(text) =>
            setState({
              ...state,
              museumItem: { ...state.museumItem, nameOfArtwork: text },
            })
          }
      ...
      <View>
        ...
        <TextInput
          ...
          onChangeText={(text) =>
            setState({
              ...state,
              museumItem: { ...state.museumItem, artistName: text },
            })
          }
      ...
      <View>
        ...
        <TextInput
          placeholder="Enter synopsis of artwork here. Max length is 256 characters"
          onChangeText={(text) =>
            setState({
              ...state,
              museumItem: { ...state.museumItem, synopsis: text },
            })
          }
          multiline
          maxLength={256}
      ...
      <View>
        ...
        <TextInput
          placeholder="Enter email address of artist here"
          onChangeText={(text) =>
            setState({
              ...state,
              museumItem: { ...state.museumItem, artistEmailAddress: text },
            })
          }
      ...
      <View>
        ...
        >
          <Text>
            {state.museumItem.dateCommissioned
              ? state.museumItem.dateCommissioned.toLocaleDateString("en-gb")
        ...
        {state.showDatePicker && (
          <DateTimePicker
            value={
              state.museumItem.dateCommissioned !== undefined
                ? state.museumItem.dateCommissioned
                : new Date()
            }
            mode={"date"}
      ...
      >
        ...
        <Switch
          onValueChange={(newValue) => {
            setState({
              ...state,
              museumItem: { ...state.museumItem, onDisplay: newValue },
            });
          }}
      ...
      <View>
        ...
        <Slider
          ...
          onValueChange={(newValue) => {
            setState({
              ...state,
              museumItem: { ...state.museumItem, viewerRating: newValue },
            });
          }}
          step={1}
        />
